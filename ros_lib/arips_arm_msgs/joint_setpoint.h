#ifndef _ROS_arips_arm_msgs_joint_setpoint_h
#define _ROS_arips_arm_msgs_joint_setpoint_h
...
namespace arips_arm_msgs
{
  ...
  class joint_setpoint : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "arips_arm_msgs/joint_setpoint"; };

...
hw::L298Motor hw::l298motor4("joint34_right_motor", JOINT34_RIGHT_IN1_GPIO_Port, JOINT34_RIGHT_IN1_Pin, JOINT34_RIGHT_IN2_GPIO_Port, JOINT34_RIGHT_IN2_Pin, TIM2, TIM2->CCR1);
hw::L298Motor hw::l298motor5("gripper_motor", GRIPPER_IN1_GPIO_Port, GRIPPER_IN1_Pin, GRIPPER_IN2_GPIO_Port, GRIPPER_IN2_Pin, TIM2, TIM2->CCR1);
